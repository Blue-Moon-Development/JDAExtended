...
public class CoreTable extends SQLTable {
    ...
    public final static SQLColumn<Long> ALERTS_CHANNEL = new LongColumn("alerts_channel", null);
    public final static SQLColumn<Long> LOGS_CHANNEL = new LongColumn("logs_channel", null);
    public final static SQLColumn<String> PREFIX = new StringColumn("prefix", ">", 5);
